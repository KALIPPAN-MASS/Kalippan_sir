...
await message.client.sendMessage(message.jid, fs.readFileSync('./Amalser/kalippansir.webp'), MessageType.sticker, { mimetype: Mimetype.webp, quoted : message.data, ptt: false})
    }
